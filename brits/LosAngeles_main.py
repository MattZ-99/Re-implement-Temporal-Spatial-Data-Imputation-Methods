...
valid_mask_set = LosAngelesHighwaySpeedImputationTestSet(raw_data_dir="./datasets/LosAngeles_HighwaySpeed_data.npy",
...
version = 2
model_path = "./outputs/LosAngeles_data_v{}/{}/models/".format(version, name)
plot_path = "./outputs/LosAngeles_data_v{}/{}/visualization/".format(version, name)
log_path = "./outputs/LosAngeles_data_v{}/{}/logs/".format(version, name)
