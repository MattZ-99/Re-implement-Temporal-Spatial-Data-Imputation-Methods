...
train_set = BeijingTaxiFlowImputationTrainSet(raw_data_dir="./datasets/Beijing_TaxiFlow_data.npy",
...
valid_set = BeijingTaxiFlowImputationTestSet(raw_data_dir="./datasets/Beijing_TaxiFlow_data.npy",
                                             missing_type=args.missing_type, missing_rate=args.missing_rate,
                                             num_timestamp=22272, train_proportion=0.95,
                                             seq_len=args.seq_len, grid_size_x=32, grid_size_y=32, feature_channels=1)
...
valid_mask_set = BeijingTaxiFlowImputationTestSet(raw_data_dir="./datasets/Beijing_TaxiFlow_data.npy",
                                                  missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                  num_timestamp=22272, train_proportion=0.95,
...
version = 2
model_path = "./outputs/Beijing_data_v{}/{}/models/".format(version, name)
plot_path = "./outputs/Beijing_data_v{}/{}/visualization/".format(version, name)
log_path = "./outputs/Beijing_data_v{}/{}/logs/".format(version, name)
