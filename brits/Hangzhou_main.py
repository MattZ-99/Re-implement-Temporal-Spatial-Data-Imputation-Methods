...
# (2625, 81, 1)
train_set = LosAngelesHighwaySpeedImputationTrainSet(raw_data_dir="./datasets/Hangzhou_data.npy",
...
valid_set = LosAngelesHighwaySpeedImputationTestSet(raw_data_dir="./datasets/Hangzhou_data.npy",
                                                    raw_adjacency_dir="./datasets/Hangzhou_adjacency.npy",
                                                    missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                    num_timestamp=2625, train_proportion=0.95,
                                                    seq_len=8, graph_size=81, feature_channels=1)
...
valid_mask_set = LosAngelesHighwaySpeedImputationTestSet(raw_data_dir="./datasets/Hangzhou_data.npy",
                                                         raw_adjacency_dir="./datasets/Hangzhou_adjacency.npy",
                                                         missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                         num_timestamp=2625, train_proportion=0.95,
                                                         seq_len=8, graph_size=81, feature_channels=1)
...
version = 1
dataset_name = "Hangzhou_data_v{}".format(version)
