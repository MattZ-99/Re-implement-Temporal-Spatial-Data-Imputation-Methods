...
valid_set = LosAngelesHighwaySpeedImputationTestSet(raw_data_dir="./datasets/Shenzhen_data.npy",
                                                    raw_adjacency_dir="./datasets/Shenzhen_adjacency.npy",
                                                    missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                    num_timestamp=2970, train_proportion=0.95,
                                                    seq_len=8, graph_size=165, feature_channels=1)
...
valid_mask_set = LosAngelesHighwaySpeedImputationTestSet(raw_data_dir="./datasets/Shenzhen_data.npy",
                                                         raw_adjacency_dir="./datasets/Shenzhen_adjacency.npy",
                                                         missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                         num_timestamp=2970, train_proportion=0.95,
                                                         seq_len=8, graph_size=165, feature_channels=1)
...
version = 3
model_path = "./outputs/Shenzhen_data_v{}/{}/models/".format(version, name)
plot_path = "./outputs/Shenzhen_data_v{}/{}/visualization/".format(version, name)
log_path = "./outputs/Shenzhen_data_v{}/{}/logs/".format(version, name)
