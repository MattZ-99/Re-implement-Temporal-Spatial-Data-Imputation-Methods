...
train_set = LosAngelesHighwaySpeedPredictionTrainSet(raw_data_dir="./datasets/Hangzhou_data.npy",
...
version = 2
dataset_name = "Predict_Hangzhou_data_v{}".format(version)
...
for epoch in range(args.epochs):
    ...
    with torch.no_grad():
        mask_zero = torch.zeros(args.batch_size, args.seq_len, 81)
        if args.cuda_is_available:
