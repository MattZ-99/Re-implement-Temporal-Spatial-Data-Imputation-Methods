...
train_set = LosAngelesHighwaySpeedPredictionTrainSet(raw_data_dir="./datasets/LosAngeles_HighwaySpeed_data.npy",
...
valid_set = LosAngelesHighwaySpeedPredictionTestSet(raw_data_dir="./datasets/LosAngeles_HighwaySpeed_data.npy",
                                                    raw_adjacency_dir="./datasets/LosAngeles_HighwaySpeed_adjacency"
                                                                      ".npy",
                                                    missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                    num_timestamp=34272, train_proportion=0.95,
...
valid_mask_set = LosAngelesHighwaySpeedPredictionTestSet(raw_data_dir="./datasets/LosAngeles_HighwaySpeed_data.npy",
                                                         raw_adjacency_dir="./datasets"
                                                                           "/LosAngeles_HighwaySpeed_adjacency.npy",
                                                         missing_type=args.missing_type, missing_rate=args.missing_rate,
                                                         num_timestamp=34272, train_proportion=0.95,
                                                         seq_len=8, graph_size=207, feature_channels=1)
...
version = 1
dataset_name = "Predict_LosAngeles_data_v{}".format(version)
...
for epoch in range(args.epochs):
    ...
    with torch.no_grad():
        mask_zero = torch.zeros(args.batch_size, args.seq_len, 207)
        if args.cuda_is_available:
